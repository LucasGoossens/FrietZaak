            ...
            <div className="w-1/2 h-48 my-2 flex justify-center ">
                <div className="flex justify-between w-11/12 h-full bg-slate-100 text-black  border rounded rounded-xl shadow-md">
                    ...
                    <div className="mx-2 my-2">
                        ...
                        {discount > 0 ?
                            (<><div className="text-xl flex flex-row font-bold text-red-600"><div className="pr-2 italic font-bold line-through text-black">&euro;{price.toFixed(2)}</div>&euro;{(price - discount).toFixed(2)}</div></>)
                            :
                            (<div className="text-xl my-2 italic font-semibold ">&euro;{price.toFixed(2)}</div>)
                        }
                    </div>
