    ...
    return (
        <>
            ...
            <form onSubmit={handleRegistration}>
                ...
                <input className="my-2 text-black bg-slate-300" type="text" id="name" name="name" /><br />              
                ...
                <input className="my-2 text-black bg-slate-300" type="password" id="password" name="password" /><br />
                <label className="text-black font-semibold" htmlFor="password-confirm">Confirm Password:</label><br />
                <input className="my-2 text-black bg-slate-300" type="password" id="password-confirm" name="password-confirm" /><br />
